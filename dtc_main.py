...
def print_expected_result(formula: FNode, to_print: bool = True):
...
files = utils.read_bench_files(1)
for _, file_ in files:
    assert print_expected_result(file_, False) == DTC(file_)
